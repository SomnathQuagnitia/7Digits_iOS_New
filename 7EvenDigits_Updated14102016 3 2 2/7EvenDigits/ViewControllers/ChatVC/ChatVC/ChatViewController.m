...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // CGSize textSize = { 290.0, 10000.0 };
    ...
    //size = [message sizeWithFont:[UIFont boldSystemFontOfSize:13]constrainedToSize:textSize lineBreakMode:NSLineBreakByWordWrapping];
     size = [message sizeWithAttributes:
    ...
    if ([sender isEqualToString:@"me"])
    {
        ...
        [cell.messageContentView setFrame:CGRectMake(65, padding*2, size.width+sizeOfWidthHeight, size.height+sizeOfWidthHeight+20)];
        
        [cell.bgImageView setFrame:CGRectMake( cell.messageContentView.frame.origin.x - padding/2, cell.messageContentView.frame.origin.y - padding/2, size.width+padding + sizeOfWidthHeight,size.height+padding+sizeOfWidthHeight+16)];
        
        [cell.replyImageView setFrame:CGRectMake(5, height, 50, 50)];
        cell.replyImageView.image=[UIImage imageNamed:@"profil_img3.png"];
    ...
    else
    {
        ...
        [cell.messageContentView setFrame:CGRectMake(320 - size.width - xOrigin ,padding*2,size.width+sizeOfWidthHeight-58,size.height+sizeOfWidthHeight+26)];
        
        [cell.bgImageView setFrame:CGRectMake(cell.messageContentView.frame.origin.x-3, cell.messageContentView.frame.origin.y - padding/2, size.width+padding + sizeOfWidthHeight-58 ,size.height+padding+sizeOfWidthHeight+26)];
        
        
        [cell.senderImageView setFrame:CGRectMake(SCREEN_WIDTH-55, height, 50, 50)];
        cell.senderImageView.image=[UIImage imageNamed:@"profil_img4.png"];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   CGSize size = [[[chatMessageArray objectAtIndex:indexPath.section] valueForKey:@"sname"] sizeWithAttributes:
            @{NSFontAttributeName: [UIFont systemFontOfSize:13]}];
...
- (BOOL)textFieldShouldBeginEditing:(UITextField *)textField
{
    [UIView animateWithDuration:0.3 animations:^{
        ...
        {
            float height1 = tableViewObj.frame.size.height;
            height1 = height1 - 170;

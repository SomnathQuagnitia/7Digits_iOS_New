...
zss_editor.setBoldFalse = function(bold) {
...
zss_editor.prepareInsertBlueColor = function() {
	zss_editor.backuprangeblue();
}

zss_editor.backuprangeblue = function(){
//    var selection = window.getSelection();
//    var range = selection.getRangeAt(0);
//    zss_editor.currentSelection = {"startContainer": range.startContainer, "startOffset":range.startOffset,"endContainer":range.endContainer, "endOffset":range.endOffset};
...
zss_editor.setTextFont = function(Font) {
    //    document.execCommand('fontFamily', false, null);
    //	zss_editor.enabledEditingItems();
    
	zss_editor.restorerange();
	document.execCommand("styleWithCSS", null, true);
	document.execCommand('fontFamily', false, Font);
	document.execCommand("styleWithCSS", null, false);
	zss_editor.enabledEditingItems();
}
//zss_editor.setTextSize = function(Size) {
//    //    document.execCommand('fontFamily', false, null);
//    //	zss_editor.enabledEditingItems();
//    
//	zss_editor.restorerange();
